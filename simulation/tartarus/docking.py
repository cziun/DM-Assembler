...
def perform_calc_single(smi, receptor_type, docking_program='qvina'): 
    ...
    receptor_type : str
        The type of the receptor. This function currently supports '4lde'
    ...
    and the specified docking program for the docking process. ntermediIate files (pdbqt format) 
