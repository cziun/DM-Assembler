...
where the candidate of dataset are 'hce', 'gdb13', 'snb60k', and 'dtp'. The following are examples of molecules generated by DM-Assembler for each domain and property: 
